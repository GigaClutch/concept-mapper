...
- **Still blocked on the human:** verdicts in `review.html` (now 80 queued + any browse-time provisionals). The static no-server viewer still works; only research needs `serve.py`.
